...
namespace SAGM.Migrations
{
    ...
    [Migration("20250228184407_sat_TipoComprobantes")]
    partial class sat_TipoComprobantes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAGM.Data.Entities.WorkOrderDelivery", b =>
                {
                    b.Property<int>("WorkOrderDeliveryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WorkOrderDeliveryId"));
                    ...
                    b.Property<string>("WorkOrderDeliveryName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("WorkOrderDeliveryId");

                    b.HasIndex("WorkOrderId");

                    b.ToTable("WorkOrderDeliveries");
                });

            modelBuilder.Entity("SAGM.Data.Entities.WorkOrderDeliveryDetail", b =>
                {
                    b.Property<int>("WorkOrderDeliverDetailyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WorkOrderDeliverDetailyId"));
                    ...
                    b.HasKey("WorkOrderDeliverDetailyId");

                    b.HasIndex("WorkOrderDeliveryId");

                    b.HasIndex("WorkOrderDetailId");

                    b.ToTable("workOrderDeliveryDetails");
                });
            ...
            modelBuilder.Entity("SAGM.Data.Entities.sat_TipoComprobantes", b =>
                {
                    ...
                    b.ToTable("sat_TipoComprobantes");
                });
            ...
            modelBuilder.Entity("SAGM.Data.Entities.WorkOrderDeliveryDetail", b =>
                {
                    ...
                    b.Navigation("workOrderDelivery");
